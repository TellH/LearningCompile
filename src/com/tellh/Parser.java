...
import com.tellh.AbstractSyntaxTree.ASTList;
...
public class Parser {
    ...
    protected static class IdToken extends AToken {
        ...
        protected boolean test(Token t) {
            return t instanceof com.tellh.Token.IdToken && !reserved.contains(t.getValue());
        }
    }
    ...
    protected static class NumToken extends AToken {
        ...
        protected boolean test(Token t) {
            return t instanceof com.tellh.Token.NumToken;
        }
    }
    ...
    protected static class StrToken extends AToken {
        ...
        protected boolean test(Token t) {
            return t instanceof com.tellh.Token.StringToken;
        }
    }
    ...
    protected static class Leaf extends Element {
        ...
        protected void parse(Lexer lexer, List<ASTree> res)
                throws ParseException {
            Token t = lexer.read();
            if (t instanceof com.tellh.Token.IdToken)
